...
func TestCredentialRotationCapabilityRequiresDurableStore(t *testing.T) {
	...
	if features := legacy.capabilities().GetFeatures(); len(features) != 5 || features[4] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_TERMINAL_EVIDENCE_V1 || features[0] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_DURABLE_LEASE_ACKNOWLEDGEMENTS || features[1] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_JOB_CORRELATION_V1 || features[2] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_OBJECT_UPLOAD_IDENTITY || features[3] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_RESTART_UPLOAD_RECOVERY {
	...
	if len(features) != 6 || features[5] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_TERMINAL_EVIDENCE_V1 || features[1] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_CREDENTIAL_ROTATION || features[2] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_JOB_CORRELATION_V1 || features[3] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_OBJECT_UPLOAD_IDENTITY || features[4] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_RESTART_UPLOAD_RECOVERY {
	...
	if features := incapable.capabilities().GetFeatures(); len(features) != 5 || features[0] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_DURABLE_LEASE_ACKNOWLEDGEMENTS || features[1] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_JOB_CORRELATION_V1 || features[2] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_OBJECT_UPLOAD_IDENTITY || features[3] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_RESTART_UPLOAD_RECOVERY || features[4] != runnerv1.ProtocolFeature_PROTOCOL_FEATURE_TERMINAL_EVIDENCE_V1 {
