...
func (c Config) validatePublic() error {
	...
	if err := validateIdentifier("runnerId", c.RunnerID, maximumIdentifierBytes); err != nil {
		return err
	}
	if err := validateIdentifier("instanceId", c.InstanceID, maximumIdentifierBytes); err != nil {
		return err
	}
	...
	case ScopeOrganization:
		if err := validateIdentifier("expectedScope.organizationId", c.ExpectedScope.OrganizationID, maximumIdentifierBytes); err != nil {
			return err
		}
	default:
